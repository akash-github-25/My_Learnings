...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<MyErrorDetails> handleStudentException(CommentException exp,WebRequest req){
	...
	public ResponseEntity<MyErrorDetails> handleStudentException(LoginException exp,WebRequest req){
	MyErrorDetails err=new MyErrorDetails(LocalDateTime.now(), exp.getMessage(), req.getDescription(false));
	return new ResponseEntity<>(err,HttpStatus.NOT_FOUND);
	}
	@ExceptionHandler(PostException.class)
	public ResponseEntity<MyErrorDetails> handleStudentException(PostException exp,WebRequest req){
	MyErrorDetails err=new MyErrorDetails(LocalDateTime.now(), exp.getMessage(), req.getDescription(false));
	return new ResponseEntity<>(err,HttpStatus.NOT_FOUND);
	}
